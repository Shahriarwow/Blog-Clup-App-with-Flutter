...
class AppDatabase {
  ...
  static List<OnBordingItem> get onBordingItem {
    ...
    for(var i=0 ; i<4 ; i++){
       items.add(OnBordingItem('Read the article you want instantly', 'You can read thousands of articles on Blog Club, save them in the application and share them with your loved ones.'));
