...
class $AssetsImgBackgroundGen {
  ...
  /// File path: assets/img/background/onBording.png
  AssetGenImage get onBording =>
      const AssetGenImage('assets/img/background/onBording.png');
  ...
  /// File path: assets/img/background/spalsh.png
  AssetGenImage get spalsh =>
      const AssetGenImage('assets/img/background/spalsh.png');
}
...
class $AssetsImgIconsGen {
  ...
  /// File path: assets/img/icons/searchAvctive.png
  AssetGenImage get searchAvctive =>
      const AssetGenImage('assets/img/icons/searchAvctive.png');
}
...
class $AssetsImgStoriesGen {
  ...
  /// File path: assets/img/stories/placeholder.jpg
  AssetGenImage get placeholder =>
      const AssetGenImage('assets/img/stories/placeholder.jpg');
